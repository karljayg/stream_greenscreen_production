const playerList = [
	...
	['AngrySpaceHares', 'FSL_team_ASH_planet_intro.mp4', 'angry_space_hares.wav', 'noTitle'],
	...
	['BeanTheBard', 'FSL_BeanTheBard.mp4', 'FSL_BeanTheBard.wav'],
	['Bistork', 'Bistork.mp4', ''],
	...
	['Chat-omic', 'FSL_Chatomic.mp4', 'FSL_Chatomic.wav'],
	['CheesyNachos', 'FSL_team_CN_marble_animation.mp4', 'cheesy_nachos.wav', 'noTitle'],
	...
	['CrankyToaster', 'FSL_CrankyToaster.mp4', 'FSL_CrankyToaster.wav'],
	['Cubano', 'FSL_Cubano.mp4', 'FSL_Cubano.wav'],
	['Cypem', 'PSL_Cypem.mp4', 'freeden.wav'],
	['DarkBlade', 'FSL_DarkBlade.mp4', 'FSL_DarkBlade.wav'],
	...
	['Frost', 'FSL_FRost.mp4', 'FSL_FRost.wav', 'FRost'],
	...
	['Greeempire', 'greempire.mp4', 'greempire.wav'],
	...
	['Infestor-x', 'FSL_Infestor-x.mp4', 'FSL_Infestor-x.wav'],
	['InfiniteCyclists', 'FSL_team_IC_marble_animation.mp4', 'infinite_cyclists.wav', 'noTitle'],
	['Instability', 'Instability.mp4', 'Instability.wav'],
	['JDR', 'PSL_JDR.mp4', 'cloak.wav'],
	['JudgeFae', 'FSL_JudgeFae.mp4', 'FSL_JudgeFae.wav'],
	['Kas', 'PSL_Kas.mp4', ''],
	...
	['Nachoz', 'FSL_Nachoz3.mp4', 'Nachoz.wav'],
	...
	['Poellie', 'FSL_Poellie.mp4', 'FSL_Poellie.wav'],
	['Portrial', 'PSL_Portrial.mp4', 'freeden.wav'],
	['PorkSisig', 'FSL_PorkSisig.mp4', 'FSL_PorkSisig.wav'],
	['PossiblyMayB', 'FSL_PossiblyMayB.mp4', 'FSL_PossiblyMayB.wav'],
	['PSIOP Gaming', 'FSL_team_POG_planet_intro.mp4', 'FSL_PSISOP_Gaming.wav', 'noTitle'],
	['PulledTheBoys', 'FSL_team_PTB_planet_intro.mp4', 'pulled_the_boys.wav', 'noTitle'],
	['PvP', 'PvP.webm', ''],
	['RagesRaiders', 'FSL_team_RR_marble_animation.mp4', 'rages_raiders.wav', 'noTitle'],
	['Random Music', 'transparent_greenscreen.mp4', '', 'randomAudio'],
	['Ranger', 'PSL_Ranger.mp4', ''],
	['Reevou', 'FSL_Reevou.mp4', 'FSL_Reevou.wav'],
	['RevenantRage', 'RevenantRage.mp4', 'RevenantRage.wav'],
	['Rixilius', 'PSL_Rixilius.mp4', 'freeden.wav'],
	['SaraNghae', 'FSL_SaraNghae.mp4', 'FSL_SaraNghae.wav'],
	...
	['fenrir', 'FSL_Fenrir2.mp4', 'fenrir.wav'],
